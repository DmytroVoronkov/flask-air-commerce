...
def create_user(name, email, password, role_name):
    ...
    try:
        ...
        user = User(
            ...
            password_changed=False  # Новий користувач повинен змінити пароль
        )
...
def change_user_password(user_id, new_password, admin_id):
    ...
    try:
        ...
        # Оновлюємо пароль і скидаємо password_changed
        user.password_hash = password_hash
        user.password_changed = False  # Користувач повинен змінити пароль
        User.query.session.commit()
...
def change_user_password_by_user(user_id, current_password, new_password):
    ...
    try:
        ...
        # Оновлюємо пароль і встановлюємо password_changed
        user.password_hash = password_hash
