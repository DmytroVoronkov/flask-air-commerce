...
# Устанавливаем системные зависимости (curl, gnupg2, unixODBC и т.п.)
...
# Добавляем репозиторий Microsoft и устанавливаем ODBC-драйвер
...
# Открываем порт (если приложение слушает HTTP)
EXPOSE 8000
